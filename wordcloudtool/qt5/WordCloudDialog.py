...
GUI class for Qt5 display of the Word Cloud in a separate window.
"""

from PyQt5.QtWidgets import QDialog, QDesktopWidget, QGraphicsScene, QFileDialog
from PyQt5.QtWidgets import QApplication, QWidget, QPushButton, QMessageBox, QGraphicsPixmapItem
