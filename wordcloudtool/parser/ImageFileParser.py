...
Specialized class for raw image file based input decoders providing source for words to cloudify.
"""
...
class ImageFileParser(FileParser):
    """
    Specialized class for raw image file based input decoders.
    """
    def __init__(self, filename=None):
        ...
        """
        self.regexp = None
        super(ImageFileParser, self).__init__(filename)

    def parse(self):
        """
        Parse the contents of the raw image file and extract all the words into a list.
